    ...
    for list in alllists:
        with open(list) as f:
            for line in f:
                ...
                if sublistdirprefix in ['none', 'None', 'NONE']:
...
def joinup(cd, cindex, od, oindex, outcoaddname, outocname, coaddcat):
    ...
    outdata = numpy.zeros(nrows, dtype=[('NUMBER', 'i4'), ('NEPOCHS', 'i4'), ('WAVG_MAG_PSF', 'f4'),
                                        ('WAVG_MAGERR_PSF', 'f4'), ('WAVG_MAGRMS_PSF', 'f4'),
                                        ('WAVG_SPREAD_MODEL', 'f4'), ('WAVG_SPREADERR_MODEL', 'f4'),
                                        ('DUP', 'i4')])
    ...
    nocrows = necid.size
    outocdata = numpy.zeros(nocrows, dtype=[('COADD_FILENAME', 'a72'), ('NUMBER', 'i4'),
                                            ('FILENAME', 'a60'), ('SE_OBJECT_NUMBER', 'i4'),
                                            ('DUP', 'i4')])
